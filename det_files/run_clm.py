...
def main(det_callback, tb_callback, model_args, data_args, training_args):
    ...
    logging.error(f"text_column_name={text_column_name}")
    ...
    logging.error(f"eval dataset = {eval_dataset[0]}")
    logging.error(f"train dataset = {train_dataset[0]}")
